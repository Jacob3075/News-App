...
public interface ArticleAPI {
    ...
    @GET("news")
    Call<MediaStackResponse> getNewsFromSource(
    ...
    @GET("news")
    Call<MediaStackResponse> getTrendingNews(
            @Query("access_key") String apiKey,
            @Query("languages") String language,
            @Query("limit") int pageSize,
            @Query("offset") int pageOffset);
    ...
    @GET("news")
    Call<MediaStackResponse> getNewsByKeyWords(
            @Query("access_key") String apiKey,
    ...
    @GET("news")
    Call<MediaStackResponse> getNewsFromCategory(
            @Query("access_key") String apiKey,
